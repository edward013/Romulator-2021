...
namespace Romulator {
	...
	//	By:				Team Romulator:
	//					Chutong Shen, Zhuoxuan Zhang, Abdulrahman A Nur Farah,
	//					Adrian
	//	For:			BEE Capstone; University of Washington, Bothell
	...
	//	Acknowledgements:
	//					David G Landry, a UWB alumni, previous Romulator software developer,
	//                  give us full support for the code.
	//-------------------------------------------------------------------------
